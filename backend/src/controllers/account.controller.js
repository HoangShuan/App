...
exports.postLogin = async (req, res) => {
  try {
    ...
    // DEBUG: Log that we are setting cookie for login
    console.log('[account.controller] setting JWT cookie for login, accountId=', account._id);
...
exports.postLoginSocialNetwork = async (req, res) => {
  try {
    ...
    // DEBUG: Log that we are setting cookie for social login
    console.log('[account.controller] setting JWT cookie for social login, accountId=', accountId);
